<?php
/**
 * The template for the requests landing page
 * This shows inquiries that the user has recieved for any of their listings
 *
        ...
        <div id="content" class="grow flex flex-col relative">
            <div class="container md:grid md:grid-cols-9 xl:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="col md:col-span-6 py-6 md:py-12">
                    ...
                    <div class="mb-6 flex justify-between items-center flex-row">
                        <a href="/requests"><h1 class="font-bold text-22 sm:text-25">My Requests</h1></a>
                    </div>
                    ...
                    <?php if (!is_user_logged_in()) { ?>
                        ...
                        <span x-init="showLoginModal = true; showSignupModal = false; loginModalMessage = 'Sign in to see your requests';"></span>
                        ...
                        <div class="font-sun-motter text-center px-4 pb-16 pt-12 sm:py-20 relative flex items-center justify-center flex-col">
                            ...
                            <div class="pb-32 relative z-10">
                                <span class="text-18 sm:text-22 block text-center mb-4">Log in to see your requests</span>
