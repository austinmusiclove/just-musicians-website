...
<header class="bg-yellow-light pt-12 md:pt-24 pb-8 md:pb-16 relative overflow-hidden">
    <div class="container relative">
        ...
        <p class="text-20 mt-4 max-w-2xl">HireMusicians.com is a free online marketplace for live musicians.</p>
    </div>
</header>
...
<div class="container max-w-3xl mx-auto py-8 md:py-12">
    <section class="mb-10">
        <h2 class="font-sun-motter text-25 mb-4">What is HireMusicians.com?</h2>
        <p class="text-16 leading-relaxed mb-4">HireMusicians.com is a free online marketplace for live musicians. At its core, HireMusicians.com is a musician directory. There are no paywalls and no fees for connecting with musicians.</p>
    </section>
    ...
    <section class="mb-10">
        ...
        <div class="mb-6">
            ...
            <p class="text-16 leading-relaxed">Our mission is to help people Hire More Musicians. We are building the go-to marketplace for live musicians in the United States and Canada. HireMusicians.com strives to have the highest inventory of musicians for buyers to choose from, and we put our money where our mouth is. There are no compulsory platform fees on HireMusicians.com. That way, the platform is accessible to everyone.</p>
        </div>
        <div class="mb-6">
    ...
    <section class="mb-10">
        ...
        <div class="flex flex-col sm:flex-row gap-6">
            <img class="w-full sm:w-56 h-auto object-cover border border-black/20 shrink-0" src="https://hiremusicians.com/wp-content/uploads/2026/08/headshot-large.jpg" alt="John Filippone, founder of HireMusicians.com" />
            <div>
                <p class="text-16 leading-relaxed mb-4">HireMusicians.com was founded by John Filippone, a musician and software engineer based in Austin, Texas. John spent 5 years working as a professional software engineer before going full-time with Austin Music Love, the music promotion company he founded in Austin, Texas. Over the next 5 years, John promoted local shows and released his own music under the name Johnny Fantana.</p>
                <p class="text-16 leading-relaxed mb-4">Throughout his years of playing, promoting, and booking across the Austin scene, John noticed one core problem that inspired him to start HireMusicians.com. Musicians were sending hundreds of emails per week to get gigs, and talent buyers were spending countless hours reading, organizing, and responding to those emails. It was a ton of work on both sides that could be solved by an elegant solution, a directory. He saw the opportunity to solve the problem and decided to be the one to build it. The relationships he had developed as a music promoter, with artists and talent buyers in the local scene, became the foundation he leveraged to get the platform started.</p>
            </div>
        </div>
    </section>
</div>
