...
if (empty($search_term)) {
    get_template_part('template-parts/search/active-search/mobile-search-state-1', '', []);
} else {
    $listings = [];
    ...
    get_template_part('template-parts/search/active-search/mobile-search-state-2', '', [
        'listings' => $listings,
