...
function html_api_rewrite_rules() {
    ...
    add_rewrite_rule(
        ...
        'index.php?wp-html-v1=events&event-id=$matches[1]',
        'top'
    );
    add_rewrite_rule(
    ...
    add_rewrite_rule(
        '^wp-html/v1/proposals/([0-9]+)/respond-to-inquiry/?$',
        'index.php?wp-html-v1=respond-to-inquiry&proposal-id=$matches[1]',
        'top'
    );
