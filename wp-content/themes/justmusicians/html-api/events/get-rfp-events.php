...
if (count($events) > 0) {
    foreach ($events as $index => $event) {
        ...
        get_template_part('template-parts/cards/rfp-event-card', '', [
            'event_id'       => $event_id,
            ...
            'proposal_listing_ids' => hm_get_listing_ids_by_event_id($event_id),
    ...
    get_template_part('template-parts/global/empty-states/no-rfp-events', '', []);
}
