...
if (count($listings) > 0) {
    ...
    get_template_part('template-parts/events/suggestions-heading', '', []);
    ...
    get_template_part( 'template-parts/global/empty-states/no-suggestion-listings');
}

echo '<span x-init="showSuggestions = true;"></span>';
