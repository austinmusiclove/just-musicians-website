...
function html_api_v1_template_redirects() {
    switch (get_query_var('wp-html-v1')) {
        ...
        case 'reviews':
            switch ($_SERVER['REQUEST_METHOD']) {
                case 'GET'   : include_once get_template_directory() . '/html-api/get-reviews.php'; exit;
        ...
        case 'location-search-options-pc':
            switch ($_SERVER['REQUEST_METHOD']) {
                case 'GET'   : include_once get_template_directory() . '/html-api/location-search-options-pc.php'; exit;
            }
