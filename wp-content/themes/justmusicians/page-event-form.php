        ...
        <div class="container md:grid md:grid-cols-9 gap-8 lg:gap-12">
            ...
            <div class="col md:col-span-6 py-6 md:py-12">
                ...
                <div class="mb-6 flex justify-between items-center flex-row">
                    <h1 class="font-bold text-28">Create Event</h1>
                </div>
                ...
                <form x-data="{
                            ...
                            requestQuote: false,
                            requestDraw: false,
                        }" hx-post="<?php echo site_url('/wp-html/v1/events/'); ?>" hx-target="#create-event-result"
                    ...
                    <div class="flex gap-2 mt-8">
                        <button type="submit" x-bind:disabled="genres.length < 1"
                            class="bg-yellow hover:bg-navy text-black hover:text-white px-3 py-2 rounded-sm font-sun-motter text-14 w-fit disabled:opacity-50 disabled:cursor-not-allowed">
