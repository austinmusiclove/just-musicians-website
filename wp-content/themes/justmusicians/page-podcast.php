...
<header class="bg-yellow-light pt-12 md:pt-24 pb-8 md:pb-16 relative overflow-hidden">
    ...
    <img class="w-32 absolute top-0 right-0 z-10" src="<?php echo get_template_directory_uri() . '/lib/images/other/hm-violator-amp.svg'; ?>" />
...
<div class="container lg:grid lg:grid-cols-10 gap-24 py-8">
    <div class="col lg:col-span-7 article-body mb-8 lg:mb-0">
        ...
        ?>
            <?php echo get_template_part('template-parts/cards/audio-card', '', array(
                'name' => get_the_title(),
                'date' => get_the_date(),
