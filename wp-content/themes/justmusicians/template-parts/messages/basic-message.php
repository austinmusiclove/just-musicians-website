...
<div id="<?php echo $element_id; ?>" class="w-fit max-w-[75%] <?php if ($args['is_outgoing']) { echo 'ml-auto'; }?>"
    ...
    <?php } ?>
>
<div class="text-14 <?php if ($args['is_outgoing']) { echo 'text-right'; } else { echo 'text-left'; } ?>"><?php echo $args['sender_name']; ?></div>
