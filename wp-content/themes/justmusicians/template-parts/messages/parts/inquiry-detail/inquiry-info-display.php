...
<div class="flex flex-row justify-between items-start">
    ...
    <img class="h-4 opacity-50 hover:opacity-100" src="<?php echo get_template_directory_uri() . '/lib/images/icons/pencil-solid.svg'; ?>" x-on:click="editInquiryMode = true"/>
</div>
...
<div class="flex items-center gap-1 pb-4">
    ...
    <span class="text-16 whitespace-nowrap overflow-hidden text-ellipsis block" x-text="inquiry.location"></span>
</div>
