<div class="slide pb-8 grow w-[18rem] sm:w-[32rem] md:min-h-[30rem]" x-show="showReviewUserInfoSlide" x-cloak x-data="{
...
>
    ...
    <!-- Submit Button -->
    <div class="account-settings-indicator absolute bottom-10 right-10 flex flex-row gap-1">
