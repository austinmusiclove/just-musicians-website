<div class="slide pb-8 grow w-[18rem] sm:w-[32rem] md:min-h-[30rem] max-h-[60vh] flex flex-col overflow-y-auto pr-2" x-data="{ inquiryDuration: 0 }" x-show="showDurationSlide" x-cloak data-testid="inquiry-slide-duration">
