<div class="slide w-[24rem] text-center" x-show="showThankYouSlide" x-cloak data-testid="inquiry-slide-thankyou">
    ...
    <p class="text-18">We’ll get back to you soon with responses from musicians in your area. Check your <br><a class="underline text-yellow" x-bind:href="newEventPermalink" >responses here.</a></p>
