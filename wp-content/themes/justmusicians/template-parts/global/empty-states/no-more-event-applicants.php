<div x-show="!showSuggestions" x-collapse.duration.300ms class="overflow-hidden">
    ...
    <div
        class="font-sun-motter text-center px-4 pb-16 pt-12 sm:py-20 relative flex items-center justify-center flex-col">

        <div class="relative pb-32">

            <span class="text-22 block text-center mb-2">Looks like you've reached the <span class="text-yellow">end of
                    the trail.</span></span>
            ...
            <button type="button"
                ...
                hx-target="#applicant-results" hx-swap="beforeend" hx-indicator="#suggestion-button-content-nmr"
                hx-trigger="click">
