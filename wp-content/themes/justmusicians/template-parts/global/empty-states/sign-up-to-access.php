<?php
/**
 * Template part for the "Sign up to..." login prompt
...
$full_message = 'Sign up to ' . $message;

?>
<?php if (!$skip_x_init) { ?>
<span x-init="showLoginModal = false; showSignupModal = true; signupModalMessage = '<?php echo $full_message; ?>';"></span>
<?php } ?>
...
<div class="font-sun-motter text-center px-4 pb-16 pt-12 sm:py-20 relative flex items-center justify-center flex-col">
    ...
    <div class="pb-32 relative z-10">
        ...
        <button type="button" class="bg-yellow shadow-black-offset border-2 border-black font-sun-motter text-12 px-2 py-2"
            x-on:click="showLoginModal = false; showSignupModal = true; signupModalMessage = '<?php echo $full_message; ?>';"
        >Sign Up</button>
    </div>
