<div class="grow relative">
    ...
    <div class="relative">
        ...
        <span class="absolute inset-y-0 left-0 pl-9 flex items-center pointer-events-none"><?php echo $args['currency']; ?></span>
        <input class="!pl-12 w-full px-3 py-2" type="number" id="<?php echo $args['input_name']; ?>" name="<?php echo $args['input_name']; ?>" placeholder="<?php echo $args['placeholder']; ?>">
    </div>
</div>
