...
<div class="progress-tracker bg-yellow h-2 w-24 absolute top-0 left-0"></div>
    ...
    <div class="absolute bottom-10 right-10 flex flex-row gap-1">
        <button class="bg-white shadow-black-offset border-2 border-black hover:bg-yellow hover:text-black text-black font-sun-motter text-16 px-4 py-2">Back</button>
        <button data-trigger="slide-2" class="bg-navy shadow-black-offset border-2 border-black hover:bg-yellow hover:text-black text-white font-sun-motter text-16 px-4 py-2">Skip</button>
    </div>
