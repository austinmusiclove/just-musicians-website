<div data-slide="5" class="slide w-[24rem] text-center" x-show="showSlide5" x-cloak>
    ...
    <div class="flex flex-row gap-1 justify-center">
        ...
        <button type="button" data-trigger="slide-4" class="bg-navy shadow-black-offset border-2 border-black hover:bg-yellow hover:text-black text-white font-sun-motter text-16 px-4 py-2" x-on:click="showSlide1 = true;">Continue</button>
    </div>
