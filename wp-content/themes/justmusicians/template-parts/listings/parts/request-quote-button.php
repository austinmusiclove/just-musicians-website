...
<?php if (!empty($args['disabled']) and $args['disabled']) { ?>
    ...
    <span class="sm:absolute sm:right-0 sm:bottom-3 w-full sm:w-fit">
        <button type="button" class="hover:bg-yellow-light bg-yellow px-3 py-3 sm:py-2 rounded-sm font-sun-motter text-14 inline-block w-full sm:w-fit" >Request Quote</button>
    </span>
