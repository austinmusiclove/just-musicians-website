<div class="text-16 p-2 flex sm:items-center items-end gap-2 sm:flex-row flex-col">
    ...
    <div class="flex items-center gap-2 ">
        <?php echo get_template_part('template-parts/global/tooltips/tooltip', '', [
            'tooltip' => 'Learn more about the default Hire Musicians search algorithm <a class="text-yellow underline" target="_blank" href="' . site_url('/search-algorithm') . '">here</a>.'
        ]); ?>
