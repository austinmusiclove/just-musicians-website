<button type="button" class="flex text-16 items-center gap-1 group relative py-0.5 rounded-full md:hidden cursor-pointer gap-1.5 border border-black/20 hover:border-black px-2 font-bold" x-on:click="showMobileFilters = ! showMobileFilters">
...
<div class="mt-28 md:mt-16 w-screen h-screen fixed top-0 left-0 z-20 flex items-center justify-center" x-show="showMobileFilters" x-transition x-cloak>
    <div class="bg-white relative pt-0 px-8 md:pt-20 w-full h-full overflow-scroll pb-56">
        ...
        <div class="flex items-center justify-between mb-4 sticky top-0 bg-white py-4 w-full z-10">
            <button type="button" class="underline opacity-40 hover:opacity-100 inline-block text-14" x-on:click="showMobileFilters = ! showMobileFilters" >close</button>
