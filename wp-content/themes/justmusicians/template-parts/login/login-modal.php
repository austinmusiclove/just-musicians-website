    ...
    <div class="slide w-[32rem] pb-8 grow">
        ...
        <div class="flex min-h-full flex-col justify-center py-8 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 class="mt-6 text-25 font-bold leading-9 tracking-tight mb-12">Sign in to your account</h2>
            </div>
            <div class="sm:mx-auto sm:w-full sm:max-w-[480px]">
                <div class="bg-white px-6 pb-4 sm:px-12">
                    <form class="space-y-2" action="" method="POST"
                        hx-post="<?php echo site_url('/wp-login.php'); ?>"
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="user_pass" name="pwd" x-bind:type="showPassword ? 'text' : 'password'" autocomplete="current-password" required class="block w-full rounded-md border border-yellow px-3 py-2 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6">
