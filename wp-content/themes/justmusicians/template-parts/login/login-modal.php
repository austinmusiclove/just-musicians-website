        ...
        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-[480px]">
                <div class="bg-white px-6 pb-12 shadow sm:rounded-lg sm:px-12">
                    ...
                    >
                        <div id="login-result" class="flex items-center justify-between min-h-8"></div>
                        <div>
                            <label for="log" class="block text-sm font-medium leading-6 mt-4">Email Address</label>
                            <div class="mt-2">
                                <input id="user_login" name="log" type="email" autocomplete="email" required class="block w-full rounded-md border border-yellow px-3 py-2 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 bg-brown-light-3">
                            </div>
                        </div>
                        <div>
                            <label for="pwd" class="block text-sm font-medium leading-6 mt-4">Password</label>
                            <div class="mt-2">
                                <input id="user_pass" name="pwd" x-bind:type="showPassword ? 'text' : 'password'" autocomplete="current-password" required class="block w-full rounded-md border border-yellow px-3 py-2 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6 bg-brown-light-3">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <div class="flex items-center">
                                ...
                                <label for="rememberme" class="ml-4 block text-sm leading-6">Remember Me</label>
                            </div>
                            <div class="text-sm leading-6"><a href="<?php echo get_site_url() . '/request-password-reset'; ?>" class="hover:underline font-semibold">Forgot password?</a>
                            </div>
                        </div>
                        <div>
