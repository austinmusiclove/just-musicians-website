...
<div class="font-sun-motter text-center px-4 pb-16 pt-12 sm:py-20 relative flex items-center justify-center flex-col">
    ...
    <div class="pb-32 relative z-10">
        <span class="text-18 sm:text-22 block text-center mb-4">You don't have any requests yet</span>
        <a href="/listings"><button type="button" data-trigger="quote" class="bg-yellow shadow-black-offset border-2 border-black font-sun-motter text-12 px-2 py-2">Manage your listings</button></a>
    </div>
