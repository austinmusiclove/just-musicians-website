<div class="font-sun-motter text-center px-4 pb-28 pt-12 sm:py-20 relative mb-4 xl:mb-0 h-[70vh] flex items-center justify-center flex-col">
    ...
    <div class="pb-16 relative z-10">
        <span class="text-22 block text-center mb-2">Looks like there's <span class="text-yellow">no listings.</span></span>
        <p class="text-20 mb-4">Start a search to find listings to add to your collection.</p>
