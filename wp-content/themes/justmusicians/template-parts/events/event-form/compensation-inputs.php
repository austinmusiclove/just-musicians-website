<div class="flex flex-col gap-2 mb-4">
    <div>
        <label class="text-18 font-bold mb-3 inline-block">Live Music Budget</label>
        <div class="relative">
            <img class="h-5 absolute bottom-2.5 left-3 opacity-60"
                src="<?php echo get_template_directory_uri() . '/lib/images/icons/money-bill.svg'; ?>" />
            <span class="absolute inset-y-0 left-0 pl-9 flex items-center pointer-events-none">$</span>
            <input class="!pl-12 w-full px-3 py-2" type="number" min="0" name="event_budget" placeholder="e.g. 2,000"
                x-bind:value="budget">
        </div>
    </div>
    <div>
        <label class="text-18 font-bold mb-3 inline-block">Compensation Details</label>
        <textarea name="event_compensation" x-bind:value="compensation" class="w-full h-24 sm:h-40"
            placeholder="Describe compensation for musicians"></textarea>
    </div>
</div>
...
<div class="flex flex-col gap-2 mb-4">
    <label class="custom-checkbox flex items-center gap-2 cursor-pointer">
        ...
        <div class="text-16">Request quote from musicians</div>
    ...
    <label class="custom-checkbox flex items-center gap-2 cursor-pointer">
        ...
        <span class="checkmark"></span>
        <div class="text-16">Request draw estimate from musicians</div>
