...
<div class="flex items-center gap-2 justify-end shrink-0">
    ...
    <button id="htmx-submit-button" type="submit" class="w-fit relative rounded text-14 font-bold py-2 px-3 bg-navy text-white disabled:bg-grey disabled:text-white" x-ref="submitButton">
