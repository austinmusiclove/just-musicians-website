...
<button type="button" class="bg-navy px-3 py-2 rounded-sm font-sun-motter text-12 text-white inline-block w-full"
    disabled <?php // Handle toasts ?> <?php if ($success_toast) { ?>
