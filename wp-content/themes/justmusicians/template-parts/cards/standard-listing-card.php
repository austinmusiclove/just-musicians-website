...
<?php if (!$is_preview && !empty($args['last']) && empty($args['is_last_page'])) { // Load more results; show a button on the last result of the page as long as it is not the final page
