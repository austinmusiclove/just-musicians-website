...
<div class="flex flex-col">
    ...
    <label for="display_name" class="flex">
        ...
        <div class="group relative px-2">
            <div class="tooltip text-white bg-black px-4 py-3 text-14 rounded hidden group-hover:block absolute z-50 w-56 -top-[80px] -right-28 md:right-auto">
                This is the name other users will see when they receive messages from you.
            </div>
    ...
    <!-- Input -->
    <input class="border border-black/20 rounded h-8 p-2" type="text" name="display_name" x-bind:value="accountSettings.display_name">
