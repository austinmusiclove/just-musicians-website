...
<div id="content-wrap" class="container">
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			<div class="single-page-wrapper user-mgmt-form">
                <div id="error-container"></div>
                <div>
                    <div>
                        <a href="<?php echo login_with_google(); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Capa_1" style="enable-background:new 0 0 150 150;" version="1.1" viewBox="0 0 150 150" width="1.5em" height="1.5em" xml:space="preserve">
                ...
                <div>
                    ...
                    <div><span class="bg-white px-6 text-gray-900">Or</span></div>
                </div>
                <form id="registration-form" action="" method="POST" style="text-align: left">
                    <div>
                        <label for="email">Email Address</label>
                        <div><input style="min-width:300px" id="email" name="user_email" type="email" autocomplete="email" required></div>
                    </div>
                    <div>
                        <label for="password">Password</label>
                        <div><input style="min-width:300px" id="password" name="user_pass" type="password" autocomplete="current-password" required></div>
                    </div>
                    <div>
                        <label for="password">Confirm Password</label>
                        <div><input style="min-width:300px" id="password-conf" name="user_pass_conf" type="password" required></div>
                    </div>
                    <div>
                        <div>
                    ...
                    <div><button id="register-submit" type="submit">Sign Up</button></div>
                </form>
