	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			<div class="single-page-wrapper user-mgmt-form">
                ...
                <form action="<?php echo get_site_url() . '/wp-login.php'; ?>" method="POST">
                    <div>
                        <label for="log">Email Address</label>
                        <div><input style="min-width:300px" id="user_login" name="log" type="email" autocomplete="email" required></div>
                    </div>
                    <div>
                        <label for="pwd" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
                        <div><input style="min-width:300px" id="user_pass" name="pwd" type="password" autocomplete="current-password" required></div>
                    </div>
                    <div>
                        <div>
                        ...
                        <div><a href="<?php echo get_site_url() . '/password-reset'; ?>">Forgot Password?</a></div>
                    </div>
