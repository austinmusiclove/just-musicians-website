...
function get_sanitized_review_args($review_post_type, $reviewee_id) {
    ...
    if (isset($_POST['review_body'])) { $sanitized_args['meta_input']['review']    = sanitize_text_field($_POST['review_body']); }
    ...
    // Title
    $sanitized_args['post_title'] = $sanitized_args['meta_input']['rating'] . "/5 - " . $reviewee_id . " - " . $sanitized_args['meta_input']['author'];
