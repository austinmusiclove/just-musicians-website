...
$GOOGLE_CLIENT_ID = GB_GOOGLE_WEB_OAUTH_CLIENT_ID;
$GOOGLE_CLIENT_SECRET = GB_GOOGLE_WEB_OAUTH_CLIENT_SECRET;
$GOOGLE_REDIRECT_URI = GB_GOOGLE_WEB_OAUTH_REDIRECT_URI;
$GOOGLE_APPLICATION_NAME = "GigBuddy";
