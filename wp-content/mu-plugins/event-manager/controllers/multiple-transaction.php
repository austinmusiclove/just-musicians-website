...
function event_manager_process_multiple_selected() {
    ...
    if ( $is_approve ) {
        ...
        foreach ( $selected_indices as $index ) {
            ...
            $approve_items[] = array(
                'staged_transaction_id' => isset( $txn['staged_transaction_id'] ) && $txn['staged_transaction_id'] !== '' ? $txn['staged_transaction_id'] : '',
                'override_data'         => ! empty( $staged ) ? $staged : (object) array(),
            );
        }
