...
<div class="em-venue-future-events-container" style="max-height: 400px; overflow: auto; border: 1px solid #c3c4c7; padding: 10px;">
    <?php if ( ! empty( $future_events ) ) : ?>
        <?php foreach ( $future_events as $venue_id => $events ) : ?>
            <h3 style="margin: 10px 0 5px;">Venue ID: <?php echo esc_html( $venue_id ); ?></h3>
            <table class="wp-list-table widefat striped table-view-list" style="margin-bottom: 20px;">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 10px;">No future events for this venue.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
                <tfoot>
        ...
        <?php endforeach; ?>
    <?php else : ?>
        <p style="text-align: center; padding: 20px;">No future events found.</p>
    <?php endif; ?>
</div>
