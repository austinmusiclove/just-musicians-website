...
function send_author_comp_report_verified_email($author_email, $venue_name) {
...
function send_author_comp_report_confirmation_email($email, $venue_name, $venue_post_id, $author_id) {
