...
function update_venue_review_stats() {
    ...
    if ($venues_query->have_posts()) {
        ...
        while( $venues_query->have_posts() ) {
            ...
            $total_payment = $total_earnings - (float)get_post_meta(get_the_ID(), 'tips_earnings' , true);
            ...
            $earnings_per_hour_per_performer = round(($total_performers > 0 && $hours_performed > 0) ? $total_earnings / $hours_performed / $total_performers : 0, 2);
            ...
            $update_args = array(
                ...
                'meta_input' => array(
                    ...
                    '_earnings_per_hour_per_performer' => $earnings_per_hour_per_performer,
